...
const nosotros = () => {
	...
	return (
		<Flex alignItems={'center'}>
			...
			></Flex>
			<Flex height={'50vh'} marginLeft={-100} boxShadow={"md"} borderRadius={20}>
				<Image src={'/assets/about.jpg'} borderRadius={20} boxShadow={"md"}/>
			</Flex>
			<Flex height={'50vh'} marginLeft={10} width={"35vw"}flexDir={"column"} ali>
				<Heading size={"3xl"} color={"brand.primario"}fontFamily={'fonts.open'}>Nosotros</Heading>
